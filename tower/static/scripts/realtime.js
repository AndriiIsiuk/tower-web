...
var map = new ol.Map({
  ...
  view: new ol.View({
    center: ol.proj.transform([50.841383,19.972574], 'EPSG:4326', 'EPSG:3857'),
    zoom: 18
  })
});
...
'<img src="static/images/roboauto2.jpeg" height="50" style="z-index: 100; position: absolute; top: 50%; left: 50%; margin-left: -43px; margin-top: -20px;">';
